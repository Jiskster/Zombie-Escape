...
ZE.G_AddToDamageTable(20*FRACUNIT, "%s killed %s.", ZE.G_OofBall)
ZE.G_AddToDamageTable(20*FRACUNIT, "%s killed %s.", ZE.G_SteveCrossbow)
ZE.G_AddToDamageTable(20*FRACUNIT, "%s killed %s.", ZE.G_SerpentineRocket)
ZE.G_AddToDamageTable(20*FRACUNIT, "%s killed %s.", ZE.G_SerpentineFire)
ZE.G_AddToDamageTable(20*FRACUNIT, "%s killed %s.", ZE.G_ScarfRevoler)
ZE.G_AddToDamageTable(10*FRACUNIT, "%s killed %s.", ZE.G_SwordDamage)
ZE.G_AddToDamageTable(20*FRACUNIT, "%s killed %s.", ZE.G_ScarfPlasmaDamage)
...
ZE.G_AddToDamageTable(38*FRACUNIT, "%s killed %s.", ZE.G_HS_PistolDamage)
